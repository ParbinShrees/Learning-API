...
import { ArrowRight, Star, Download, Heart, MessageCircle } from 'lucide-react';
...
export function PrishHomePage() {
  ...
  const galleryPhotos = [
    {
      id: '1',
      image: 'https://images.unsplash.com/photo-1753372623416-bc8bf85eab06?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMGxha2UlMjByZWZsZWN0aW9uJTIwYWxwaW5lfGVufDF8fHx8MTc3MjUzMzEzNHww&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Mountain Mirror',
      location: 'Gokyo Lakes, Nepal',
      rating: 4.9,
      downloads: 2847,
    },
    {
      id: '2',
      image: 'https://images.unsplash.com/photo-1567254695449-82d119c7c2b0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHN1bW1pdCUyMHN1bnJpc2UlMjBnb2xkZW58ZW58MXx8fHwxNzcyNTMzMTM1fDA&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Golden Summit',
    ...
    {
      id: '3',
      image: 'https://images.unsplash.com/photo-1667327625285-188640ab9d5f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHZpbGxhZ2UlMjBuZXBhbCUyMHRyYWRpdGlvbmFsfGVufDF8fHx8MTc3MjUzMzEzOHww&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Sherpa Village',
    ...
    {
      id: '4',
      image: 'https://images.unsplash.com/photo-1583003293857-6850a9a6e663?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHRyYWlsJTIwaGlraW5nJTIwcGF0hxlbnwxfHx8fDE3NzI1MDI3OTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Alpine Trail',
    ...
    {
      id: '5',
      image: 'https://images.unsplash.com/photo-1772203248551-978d4c154804?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMG1vbmFzdGVyeSUyMHRlbXBsZSUyMGhpbWFsYXlhc3xlbnwxfHx8fDE3NzI1MzMxMzl8MA&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Sacred Monastery',
      location: 'Tengboche, Nepal',
      rating: 5.0,
      downloads: 5892,
    },
    {
      id: '6',
      image: 'https://images.unsplash.com/photo-1544362289-663b68fd8b86?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHdpbGRlcm5lc3MlMjBmb3Jlc3R8ZW58MXx8fHwxNzcyNTMzMTM5fDA&ixlib=rb-4.1.0&q=80&w=1080',
    ...
    {
      id: '7',
      image: 'https://images.unsplash.com/photo-1760292452123-4cd5a11beea6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMGNhbXBpbmclMjBhZHZlbnR1cmV8ZW58MXx8fHwxNzcyNTMzMTM5fDA&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Base Camp',
    ...
    {
      id: '8',
      image: 'https://images.unsplash.com/photo-1672073235822-0518dc92106d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHNub3clMjBwZWFrcyUyMHBhbm9yYW1pY3xlbnwxfHx8fDE3NzI1MzMxNDB8MA&ixlib=rb-4.1.0&q=80&w=1080',
      name: 'Snow Peaks',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1673505413397-0cd0dc4f5854?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoaW1hbGF5YW4lMjBtb3VudGFpbiUyMGxhbmRzY2FwZSUyMHBhbm9yYW1hfGVufDF8fHx8MTc3MjUzMzEzM3ww&ixlib=rb-4.1.0&q=80&w=1080"
            alt="Hero"
      ...
      <section className="bg-white py-20 md:py-32">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <Masonry columnsCount={2} gutter="3px" className="md:hidden">
            {galleryPhotos.map((photo) => (
              <GalleryCard key={photo.id} photo={photo} />
            ))}
          </Masonry>

          <Masonry columnsCount={3} gutter="3px" className="hidden md:block lg:hidden">
            {galleryPhotos.map((photo) => (
              <GalleryCard key={photo.id} photo={photo} />
            ))}
          </Masonry>

          <Masonry columnsCount={4} gutter="3px" className="hidden lg:block">
            {galleryPhotos.map((photo) => (
              <GalleryCard key={photo.id} photo={photo} />
            ))}
          </Masonry>
      ...
      <section className="bg-white py-20 md:py-32">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-1">
            {[
              { name: 'Climbing', image: 'https://images.unsplash.com/photo-1531322804667-8d2907f41406?w=400' },
              { name: 'Trekking', image: 'https://images.unsplash.com/photo-1595248588362-18a894e156d1?w=400' },
              { name: 'Meditation', image: 'https://images.unsplash.com/photo-1525217973983-abea5c8e7f45?w=400' },
              { name: 'Photography', image: 'https://images.unsplash.com/photo-1729944080510-16b8a89df8b9?w=400' },
              { name: 'Camping', image: 'https://images.unsplash.com/photo-1760292452123-4cd5a11beea6?w=400' },
              { name: 'Wellness', image: 'https://images.unsplash.com/photo-1567254695449-82d119c7c2b0?w=400' },
            ].map((exp, index) => (
              <motion.div
                key={index}
      ...
      <section className="bg-[#0A0A0A] py-20 border-t border-white/10">
        <div className="max-w-[800px] mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            />
            <button className="px-8 py-4 bg-white text-[#0A0A0A] rounded-full hover:bg-white/90 transition-colors whitespace-nowrap">
              Subscribe
            </button>
          </motion.div>
        </div>
...
function GalleryCard({ photo }: { photo: any }) {
